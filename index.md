...
- First we need to add the name of the game to populate the list of games in the main menu.
...
- A function to execute the game will need to be created in installgames.py.
